...
import { Search, GitCompareArrows, ChevronLeft, ChevronRight, Trophy } from 'lucide-react';
import {
  listContractors,
  getHeadToHead,
  getHeadToHeadItems,
        ...
        <div className="flex items-center gap-4">
          <div className="flex-1">
            ...
            <ContractorPicker
              ...
              onSelect={(c) => { setContractorA(c); setComparing(false); }}
          ...
          <div className="flex-1">
            <label className="block text-xs font-medium text-gray-500 uppercase mb-1">Contractor B</label>
            <ContractorPicker
              selected={contractorB}
              onSelect={(c) => { setContractorB(c); setComparing(false); }}
              excludePk={contractorA?.contractor_pk}
            />
          </div>
          <div className="pt-5">
            <button
...
// ============================================================
// Contractor Picker (type-ahead search dropdown)
// ============================================================
